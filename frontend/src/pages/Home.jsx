        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up animation-delay-700">
              <Link
                to="/marketplace"
                className="group px-12 py-4 bg-gradient-to-r from-green-600 to-green-700  font-bold rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl shine-effect overflow-hidden"
              >
                <span className="flex items-center text-green-100 relative z-20">
                  🛒 Découvrir le marché
